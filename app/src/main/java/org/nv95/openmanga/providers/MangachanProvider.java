...
public class MangachanProvider extends MangaProvider {
    ...
    public MangaList getList(int page, int sort, int genre) throws Exception {
        ...
        Document document = getPage("https://mangachan.me/" + (genre == 0 ? "manga/new" : "tags/" + genreUrls[genre-1]) + "&n=" + sortUrls[sort] + "?offset=" + page * 20);
        MangaInfo manga;
        Element t;
        ...
        for (Element o : elements) {
            ...
            t = t.child(0);
            manga.name = t.text();
            manga.path = concatUrl("https://mangachan.me/", t.attr("href"));
            t = o.select("img").first();
            manga.preview = concatUrl("https://mangachan.me/", t.attr("src"));
    ...
    public MangaSummary getDetailedInfo(MangaInfo mangaInfo) {
        try {
            ...
            summary.preview = concatUrl("https://mangachan.me/", e.getElementById("cover").attr("src"));
            ...
            for (Element o : els) {
                ...
                chapter.name = o.text();
                chapter.readLink = concatUrl("https://mangachan.me/", o.attr("href"));
    ...
    public MangaList search(String query, int page) throws Exception {
        ...
        MangaList list = new MangaList();
        Document document = getPage("https://mangachan.me/?do=search&subaction=search&story=" + query);
        MangaInfo manga;
        Element t;
        Elements elements = document.body().select("div.content_row");
        for (Element o : elements) {
